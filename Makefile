...
githubpdf: $(INPUT) includes $(COVER) $(BACK)
	./includes < $< \
	| $(PANDOC) -c -s -f $(IFORMAT) --template resources/template-github.tex --include-in-header $(UNICODE_MAP) --pdf-engine=xelatex $(FLAGS) $(LFLAGS) $(PFLAGS) --metadata title="What I Wish I Knew When Learning Haskell" -o $(WPDF)
